...
The exported Go client library itself remains in `pkg/cmdraclient`, which is the conventional location for reusable Go packages. The `sdk/go/` area is reserved for SDK-facing examples and related materials.
